...
const inputClass = 'w-full border border-slate-300 focus:border-sky focus:ring-1 focus:ring-sky rounded px-3.5 py-3 text-brand-900 outline-none transition-colors text-sm bg-white'
      ...
      <div className="max-w-3xl mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-3 gap-2 mb-6">
          ...
          >
            ...
            <span className="text-sm font-black">046-205-4558</span>
          </a>
          <a
        ...
        {submitted ? (
          <div className="bg-white rounded-lg p-8 md:p-10 text-center shadow-card-lg">
            ...
            <p className="text-slate-600 text-sm leading-relaxed">
              ...
              内容を確認のうえ、営業時間内にご連絡いたします。<br />
              お急ぎの場合はお電話（046-205-4558）にてご連絡ください。
            </p>
          </div>
        ) : (
          <form onSubmit={handleSubmit} className="bg-white rounded-lg p-6 md:p-8 shadow-card-lg">
            <div className="space-y-4">
              ...
              <div>
                <label className="block text-xs font-bold text-brand-800 mb-1.5 uppercase tracking-wide">
                  住所・対応エリア <span className="text-coral-600 ml-1">必須</span>
                </label>
                <input
                  type="text"
                  name="area"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-xs font-bold text-brand-800 mb-1.5 uppercase tracking-wide">
                    建物種別 <span className="text-coral-600 ml-1">必須</span>
                  </label>
                  <select
                    name="buildingType"
              ...
              <div className="bg-sky/5 border border-sky/20 rounded p-3.5">
                ...
                <p className="text-slate-500 text-xs leading-relaxed">
                  給湯器の全体写真・型番ラベルの写真・設置場所の写真があると、より正確な概算お見積もりが可能です。
                  LINEからお写真をお送りいただくか、当フォーム送信後にメールにてお送りください。
                </p>
              </div>
